...
半开放仓库边界见
[docs/SEMI_OPEN_BOUNDARY.zh-CN.md](docs/SEMI_OPEN_BOUNDARY.zh-CN.md)，英文版见
...
状态：source-available 公共预览面，不是生产发布。

本仓库已开放用于受治理、有边界的公共预览评估。API、边界、示例和公开材料在
商业发布或生产发布前仍可能调整。

公共预览就绪、商业基线证据、硬化周期证据和健康的 finding register 都不等于
商业发布清关。商业使用、生产部署、托管服务运行和商业许可都需要单独书面授权。
